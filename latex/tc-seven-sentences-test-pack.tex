...
\begin{center}
    {\LARGE \textbf{ALPHA-PHYSICAL LANGUAGE (TC) -- SEVEN SENTENCES TEST PACK v1.0}}\\[0.75em]
\end{center}
...
\textbf{Purpose.}
This document is meant to be sufficient for an independent team to test whether TC's core operator language has real physical content across geometry, waves, chemistry, and biology.

It assumes:
\begin{itemize}[leftmargin=2em]
    \item Basic familiarity with physics, chemistry, and data analysis.
    \item No prior knowledge of CET or any other TC meta-structure.
\end{itemize}

The goal is to turn 7 compact TC ``sentences'' into falsifiable, cross-domain hypotheses that can be probed with standard models (Navier--Stokes, wave equations, reaction--diffusion, polymer growth, phase-field, etc.).


%======================================================================
\section{TC Quick Overview}
%======================================================================

TC (Theographic Calculus) is a minimal ``operator grammar'' for describing how physical systems change.
...
In practice, an TC sentence has the form
\[
...
This appendix summarizes small, sandbox-level numerical experiments that directly probe A1 and A5 in simplified settings. They are not definitive, but they are consistent with the TC claims.
...
\textbf{Caveat:}
DLA is a well-known model; the result is not new. What matters here is that TC's sentence
\[
...
\begin{itemize}[leftmargin=2em]
    \item TC provides 7 compact sentences that map onto familiar physical/chemical regimes.
...
\begin{itemize}[leftmargin=2em]
    ...
    \begin{itemize}[leftmargin=2em]
        \item Look for parameter regions where the TC-predicted regime is significantly overrepresented under LHS conditions vs controls.
        \item Report both successes and failures; both are informative for refining or rejecting TC.
    \end{itemize}
\end{itemize}
